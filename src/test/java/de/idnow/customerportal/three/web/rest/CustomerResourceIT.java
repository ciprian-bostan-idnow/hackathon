...
import de.idnow.customerportal.three.domain.Customer;
import de.idnow.customerportal.three.repository.CustomerRepository;
import de.idnow.customerportal.three.service.CustomerService;
...
public class CustomerResourceIT {
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getShortname()).isEqualTo(DEFAULT_SHORTNAME);
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.shortname").value(DEFAULT_SHORTNAME))
    ...
    public void updateCustomer() throws Exception {
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getShortname()).isEqualTo(UPDATED_SHORTNAME);
