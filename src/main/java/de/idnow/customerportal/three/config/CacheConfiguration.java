package de.idnow.customerportal.three.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.idnow.customerportal.three.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.idnow.customerportal.three.repository.UserRepository.USERS_BY_EMAIL_CACHE);
